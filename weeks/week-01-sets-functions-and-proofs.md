...
> **Definition (Cardinality).** The *cardinality* of a finite set $S$ is the number of elements it contains, written $|S|$. Duplicates are not counted: if $C = \lbrace a, a, b, b, b, c\rbrace$ then $|C| = 3$.
...
**Example.** For $S = \lbrace a, b, c\rbrace$:

$$\mathcal{P}(S) = \left \lbrace \varnothing,\ \lbrace a\rbrace,\ \lbrace b\rbrace,\ \lbrace c\rbrace,\ \lbrace a,b\rbrace,\ \lbrace a,c\rbrace,\ \lbrace b,c\rbrace,\ \lbrace a,b,c\rbrace\right\rbrace$$
...
**Example.** With $S_1 = \lbrace 2, 4\rbrace$ and $S_2 = \lbrace 2, 3, 5, 6\rbrace$:
...
Write $B = \lbrace 1, 4, 9, 16, 25, 36, 49, 64, 81, 100\rbrace$ in set-builder notation.
...
$$B = \lbrace 1, 3, 5, 7, 9\rbrace.$$

### Problem 3 — Cardinality with duplicates

Let $C = \lbrace a, a, b, b, b, c\rbrace$. What is $|C|$?

**Solution.** Duplicates are not counted: $C = \lbrace a, b, c\rbrace$, so $|C| = 3$.
...
Write all subsets of $S = \lbrace 1, 2, 3\rbrace$.

**Solution.** There are $2^{|S|} = 2^3 = 8$ subsets:

$$\mathcal{P}(S) = \left \lbrace \varnothing,\ \lbrace 1\rbrace,\ \lbrace 2\rbrace,\ \lbrace 3\rbrace,\ \lbrace 1,2\rbrace,\ \lbrace 1,3\rbrace,\ \lbrace 2,3\rbrace,\ \lbrace 1,2,3\rbrace\right\rbrace.$$
